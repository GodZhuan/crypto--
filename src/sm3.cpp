...
void SM3::BiToW(uint32_t Bi[], uint32_t W[]) {
  ...
  for (i = 16; i <= 67; i++) {
    tmp = W[i - 16] ^ W[i - 9] ^ rotl32(W[i - 3], 15);
    W[i] = SM3_p1(tmp) ^ (rotl32(W[i - 13], 7)) ^ W[i - 6];
  }
}
...
void SM3::SM3_done(SM3_STATE *md, uint8_t hash[]) {
  ...
  */
  ...
  BigEndian(hash, SM3_len / 8, hash); // if CPU uses little-endian, BigEndian
                                      // function is a necessary call
}
/******************************************************************************
 Function: SM3_256
...
int SM3::SM3_SelfTest() {
  ...
  uint8_t StdHash1[32] = {0x66, 0xC7, 0xF0, 0xF4, 0x62, 0xEE, 0xED, 0xD9,
                          0xD1, 0xF2, 0xD4, 0x6B, 0xDC, 0x10, 0xE4, 0xE2,

                          0x41, 0x67, 0xC4, 0x87, 0x5C, 0xF2, 0xF7, 0xA2,
                          0x29, 0x7D, 0xA0, 0x2B, 0x8F, 0x4B, 0xA8, 0xE0};
  uint8_t Msg2[64] = {0x61, 0x62, 0x63, 0x64, 0x61, 0x62, 0x63, 0x64,
  ...
  uint8_t StdHash2[32] = {0xde, 0xbe, 0x9f, 0xf9, 0x22, 0x75, 0xb8, 0xa1,
